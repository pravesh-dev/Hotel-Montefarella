...
function BookingForm() {
  ...
  useEffect(() => {
    if (checkInDate && checkOutDate) {
      ...
      if (!isNaN(checkIn.getTime()) && !isNaN(checkOut.getTime())) {
        ...
        const totalCost = (costPerNight * totalNights) * (1 - discount);
  ...
  return (
    ...
    >
      ...
      <p className="text-center font-bellefair text-xl my-8">
        with prosecco and rose petals or balloons
      </p>
      <p className="font-bellefair text-3xl text-center">
        Total Cost: <span className="text-primary ml-3">&euro;{totalCost}</span>
      </p>
      <button
        type="submit"
